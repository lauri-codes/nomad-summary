...
```
pip install dist/nomad-summary-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-summary" is free and open source software
